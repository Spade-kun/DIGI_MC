            ...
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-sm mb-0">Manage official documents and upload to Google Drive</p>
                    </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center py-4">
                                        <p class="text-sm text-secondary mb-0">No documents found.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-info mb-0">
                                <i class="fas fa-cloud-upload-alt"></i> 
                                <strong>Note:</strong> This document will be automatically uploaded to the designated Google Drive folder.
                            </div>
                        </div>
                    </div>
                </div>
